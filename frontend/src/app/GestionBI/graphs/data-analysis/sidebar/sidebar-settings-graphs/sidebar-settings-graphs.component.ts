...
@Component({
  selector: 'app-sidebar-settings-graphs',
  templateUrl: './sidebar-settings-graphs.component.html',
  styleUrls: ['./sidebar-settings-graphs.component.css']
})
export class SidebarSettingsGraphsComponent {
